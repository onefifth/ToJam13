...
public static class Easing
{
    ...
    public static float EaseOutExponentialInfiniteRange(double linearStepInfiniteRange)
    {
        return (float)(1.0 / (linearStepInfiniteRange + 1.0));
    }
    ...
    public static float EaseIn(double linearStep, EasingType type)
    {
        switch (type)
        {
            ...
            case EasingType.Exponential: return Exponential.EaseIn(linearStep);
        }
    ...
    public static float EaseOut(double linearStep, EasingType type)
    {
        switch (type)
        {
            ...
            case EasingType.Exponential: return Exponential.EaseOut(linearStep);
        }
        throw new NotImplementedException();
    }
    ...
    public static float EaseInOut(double linearStep, EasingType type)
    {
        switch (type)
        {
            ...
            case EasingType.Exponential: return Exponential.EaseInOut(linearStep);
        }
        throw new NotImplementedException();
    }
    ...
    static class Exponential
    {
        public static float EaseIn(double s)
        {
            return s == 0 ? 0 : (float)Math.Pow(2, 10 * (s - 1));
        }
        public static float EaseOut(double s)
        {
            return s == 1 ? 1 : 1 - (float)Math.Pow(2, -10 * s);
        }
        public static float EaseInOut(double s)
        {
            if (s == 0) return 0;
            if (s == 1) return 1;
            if ((s *= 2) < 1) return 0.5f * (float)Math.Pow(2, 10 * (s - 1));
            return 0.5f * (-(float)Math.Pow(2, -10 * (s - 1)) + 2);
        }
    }
}
